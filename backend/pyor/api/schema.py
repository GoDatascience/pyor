...
"""
    ...
    Forked from "eve_mongoengine.schema" (https://github.com/MongoEngine/eve-mongoengine)
    ~~~~~~~~~~~~~~~~~~~~~~
...
from mongoengine import (StringField, IntField, FloatField, BooleanField,
                         ...
                         ReferenceField, DynamicField, FileField, Document)
...
class SchemaMapper(object):
    ...
    @classmethod
    def _resolve_field_class(cls, field: BaseField):
        """
    ...
    @classmethod
    def create_schema(cls, model_cls: Type[Document], lowercase=True):
        """
    ...
    @classmethod
    def process_field(cls, field: BaseField, lowercase: bool):
        """
    ...
    @classmethod
    def get_subresource_settings(cls, model_cls: Type[Document], resource_name,
                                 resource_settings, registrations: Dict[Type[Document], Dict], lowercase=True):
        """
